...
export default function CallToAction(){
    return(
        ...
        <Heading textAlign={'left'} fontSize={'2xl'}>Thank You For Reading</Heading>
        <Text textAlign={'left'} fontWeight={600} fontSize={'xl'}>If you would like to get to me more, collab or even learn more about a specific project. Please get in Touch Please dont hesitate!</Text>
        <MagicLink
          href="/contact"
           passHref>
           <MotionBox
