...
export default function CallToAction(){
  ...
  const calltoaction = "If you would like to get to know me more, collab or even learn more about a specific project. Please get in Touch Please dont hesitate!"
    return(
        <Box width={'100%'} mt={16}>
         <VStack spacing={5} align={'left'}>
        <Heading textAlign={'left'} fontSize={'2xl'}>{thanks}</Heading>
        <Text textAlign={'left'} fontWeight={600} fontSize={'xl'}>{calltoaction}</Text>
        <MagicLink
          href="/contact"
           passHref>
           <MotionBox
     ...
     bg: useColorModeValue('whiteAlpha.700', 'blackAlpha.900')
                        ...
                        aria-label="get in touch with me" leftIcon={<FaPhone/>} >
           Get In Touch
        </Button>
