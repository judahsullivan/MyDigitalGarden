...
import { RepositoryProps } from "@/utils/interface";
...
export default function Repositories({repositories}: RepositoryProps){
    return(
        <Fragment>
        <PageSlideFade>
        ...
        <Box fontWeight={700} letterSpacing={'widest'}>
          ...
          Here is a list of my repositories!<Icon ml={2} as={SiGithub}/>
          <Box></Box>
          I am always making and updating projects take a look!
        </Box>
        </Box>
        </VStack>
        <MotionBox 
