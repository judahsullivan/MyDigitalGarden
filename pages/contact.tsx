...
export default function Contacts(){
    ...
    const subtitle= "Want to get in Touch with me?🤳🏾 Just fill the form out I promise to get with as soon as possible!🤙🏾 Again thank you for your time and viewing my Digital Garden! Hope you visit again!🙏🏾 "
    return(
